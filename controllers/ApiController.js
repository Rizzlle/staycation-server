...
module.exports = {
    landingPage: async (req, res) => {
        try {
            ...
            const testimonial = {
                _id: "asawadjo2i03202302",
                imageUrl: "/images/testimonial2.jpg",
                name: "Happy Family",
                rate: 4.55,
                content:
                    "What a great trip with family and I should try again next time soon...",
                familyName: "Hariyanto",
                familyOccupation: "Web / Mobile Programmer",
            };
    ...
    bookingPage: async (req, res) => {
        ...
        if (
            ...
            res.status(404).json({ message: "Must fill all Fields" });
        }
